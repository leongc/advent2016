...
console.assert(isPossibleTriangle(" 5 10 25") == false, "5 + 10 is not larger than 25");
console.assert(isPossibleTriangle(" 3 4 5"), " 3 4 5 is a common triangle");

var possibleCount = 0;
for (var i = 0; i < input.length; i++) {
  if (isPossibleTriangle(input[i])) {
    possibleCount++;
  }
}
